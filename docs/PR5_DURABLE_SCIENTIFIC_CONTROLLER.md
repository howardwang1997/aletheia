...
exact audited recovery projection. All eight active steps now have production-boundary source
slices: the three proposal steps plus protocol compilation, execution registration, validation,
